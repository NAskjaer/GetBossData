...
# Create a new folder named "BossItems" if it doesn't exist
output_folder = os.path.join(script_dir, "BossItems")
os.makedirs(output_folder, exist_ok=True)

# Determine the path for the input JSON file in the same folder as the script
input_file_path = os.path.join(script_dir, "encounter-items.json")

# Determine the path for the zone data JSON file
zone_data_file_path = os.path.join(script_dir, "instances.json")
